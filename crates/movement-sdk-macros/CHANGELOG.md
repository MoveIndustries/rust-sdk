...
All notable changes to `movement-sdk-macros` will be documented in this file.
...
### Changed
- Patch version bump to align with `movement-sdk` 0.4.1 release

## [0.2.0] - 2026-02-25

### Security
- Made path traversal check in `movement_contract_file!` non-bypassable via path canonicalization
...
### Changed
- Updated generated code to use `const-hex` instead of `hex` crate (aligns with movement-sdk 0.4.0)
...
### Added
- `movement_contract!` procedural macro for inline ABI-based contract bindings
- `movement_contract_file!` procedural macro for file-based ABI contract bindings

...
```rust
use movement_sdk::codegen::{GeneratorConfig, ModuleGenerator};
...
```rust
use movement_sdk::codegen::{GeneratorConfig, ModuleGenerator, MoveSourceParser};
...
movement-codegen --input module_abi.json --source my_module.move --output src/generated/

# From on-chain module
movement-codegen --module 0x1::coin --network testnet --output src/generated/

# With options
movement-codegen --input abi.json --output src/ \

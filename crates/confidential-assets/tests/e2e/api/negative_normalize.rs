...
/// A standalone `normalize_balance` call after a deposit + rollover succeeds (sanity
/// check that the normalize σ-proof generated by the SDK is accepted on chain even when
/// the high-level rollover wrapper isn't doing the prepending).
#[tokio::test]
